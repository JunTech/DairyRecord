...
当网站流量很小时，只需一个应用，将所有功能都部署在一起，以减少部署节点和成本。此时，用于简化增删改查工作量的数据访问框架(ORM)是影响项目开发的关键。
 ...
 ![1525529091749](1525529091749.png)
...
当访问量逐渐增大，单一应用无法满足需求，此时为了应对更高的并发和业务需求，我们根据业务功能对系统进行拆分：
 ...
 ![1525529671801](1525529671801.png)
...
当垂直应用越来越多，应用之间交互不可避免，将核心业务抽取出来，作为独立的服务，逐渐形成稳定的服务中心，使前端应用能更快速的响应多变的市场需求。此时，用于提高业务复用及整合的分布式调用是关键。
 ...
 ![1525530657919](1525530657919.png)
...
![1525530804753](1525530804753.png)
...
![1526860071166](1526860071166.png)
...
![1534812923451](1534812923451.png)
...
![1525573702492](1525573702492.png)
...
架构图：
 ...
 ![1525575656796](1525575656796.png)
...
所以 Edgware.SR3就是Edgware的第3个Release版本。  
 ...
 ![1528263985902](1528263985902.png)
...
![1528263942152](1528263942152.png)
...
![1528266515225](1528266515225.png)

next-->填写项目信息：

![1528266803455](1528266803455.png)

next -->  添加web依赖：

![1528266923967](1528266923967.png)

添加mybatis依赖：

![1528267588935](1528267588935.png)

Next -->  填写项目位置：

![1528267665004](1528267665004.png)

生成的项目结构，已经包含了引导类（itcastServiceProviderApplication）：

 ![1528267830854](1528267830854.png)
...
### 4.1.2.编写代码
 ...
 ![1535671376231](1535671376231.png)
...
![1528272537927](1528272537927.png)
...
![1528272829384](1528272829384.png)

![1528272875502](1528272875502.png)

![1528273029361](1528273029361.png)
...
### 4.2.2.编写代码
 ...
 ![1540643087305](1540643087305.png)
...
![1535587919022](1535587919022.png)
...
> 基本架构：
 ...
 ![1525597885059](1525597885059.png)
...
![1528295484808](1528295484808.png)

选择依赖：EurekaServer-服务注册中心依赖，Eureka Discovery-服务提供方和服务消费方。因为，对于eureka来说：服务提供方和服务消费方都属于客户端

![1528295612501](1528295612501.png)

![1528295690203](1528295690203.png)
...
![1525604959508](1525604959508.png)

![1533793804268](1533793804268.png)
...
![1545178177947](1545178177947.png)
...
![1528534110188](1528534110188.png)

生成的URL：

![1528534148651](1528534148651.png)

访问结果：

![1535674665806](1535674665806.png)
...
![1528691515859](1528691515859.png)
...
![1528540668018](1528540668018.png)

![1528691728618](1528691728618.png)

![1528693484031](1528693484031.png)

然后启动即可。

3）访问集群，测试：

![1528693648200](1528693648200.png)
...
![1528693943950](1528693943950.png)

10087：

![1528693979654](1528693979654.png)
...
![1528696142799](1528696142799.png)
...
![1525618396076](1525618396076.png)
...
![1525619257397](1525619257397.png)
...
首先参照itcast-eureka启动两个ItcastServiceProviderApplication实例，一个8081，一个8082。
 ...
 ![1540644966386](1540644966386.png)

Eureka监控面板：

![1540645032363](1540645032363.png)
...
![1528776489965](1528776489965.png)

继续跟入：LoadBalancerInterceptor.intercept方法

![1528775270103](1528775270103.png)

继续跟入execute方法：发现获取了8082端口的服务

![1528775890956](1528775890956.png)

再跟下一次，发现获取的是8081：

![1528775845812](1528775845812.png)
...
编写测试类，在刚才的源码中我们看到拦截中是使用RibbonLoadBalanceClient来进行负载均衡的，其中有一个choose方法，找到choose方法的接口方法，是这样介绍的：
 ...
 ![1525622320277](1525622320277.png)

现在这个就是负载均衡获取实例的方法。

我们注入这个类的对象，然后对其测试：

 ![1528780835917](1528780835917.png)
...
![1535338345659](1535338345659.png)
...
我们注意到，这个类其实是实现了接口IRule的，查看一下：
 ...
 ![1525622817451](1525622817451.png)

定义负载均衡的规则接口。

它有以下实现：

 ![1528782624098](1528782624098.png)
...
![1528782514987](1528782514987.png)
