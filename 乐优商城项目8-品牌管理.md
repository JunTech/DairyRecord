...
![1545222288968](1545222288968.png)

Brand.vue页面有一个提交按钮：

![1545222410267](1545222410267.png)

点击触发addBrand方法：

![1545222464105](1545222464105.png)

把数据模型之的show置为true，而页面中有一个弹窗与show绑定：

![1545222628405](1545222628405.png)

弹窗中有一个表单子组件，并且是一个局部子组件，有页面可以找到该组件：

![1545222756536](1545222756536.png)
...
![1530674011487](1530674011487.png)
...
![1530674402709](1530674402709.png)

看到`this.$refs`中只有一个属性，就是`myBrandForm`

我们在clear中来获取表单对象并调用reset方法：

![1545221936052](1545221936052.png)
...
![1530687657711](1530687657711.png)

校验规则的写法：

![1530688192442](1530688192442.png)
...
![1545221873038](1545221873038.png)
...
效果：
 ...
 ![1530690428352](1530690428352.png)
...
5. 弹窗提示成功还是失败，这里用到的是我们的自定义组件功能message组件：
 ...
 ![1526140298249](1526140298249.png)
...
![1532827997361](1532827997361.png)
...
![1530715294772](1530715294772.png)

![1530715390747](1530715390747.png)

![1530715447962](1530715447962.png)

![1530715487863](1530715487863.png)
...
结构：
 ...
 ![1530717442747](1530717442747.png)
...
![1545223629762](1545223629762.png)

在页面中的使用：

![1545223731347](1545223731347.png)
...
![1530720235186](1530720235186.png)

结果：

![1530720263937](1530720263937.png)

去目录下查看：

![1530720298725](1530720298725.png)
...
![1530722029884](1530722029884.png)
...
![1526200471676](1530722280952.png)

不过庆幸的是，这个错误已经不是第一次见了，跨域问题。

我们在upload-service中添加一个CorsFilter即可：

 ![1530722617437](1530722617437.png)
...
![1530722674897](1530722674897.png)

不过，非常遗憾的是，访问图片地址，却没有响应。

![1530722728379](1530722728379.png)
...
先上图：
 ...
 ![1526205318630](1526205318630.png)
...
> 上传
 ...
 ![1526205664373](1526205664373.png)
...
> 下载
 ...
 ![1526205705687](1526205705687.png)
...
![1528196441781](1528196441781.png)
...
地址：[tobato/FastDFS_client](https://github.com/tobato/FastDFS_Client)
 ...
 ![1526206304954](1526206304954.png)
...
### 3.5.2.引入配置类
 ...
 ![1528206263148](1528206263148.png)
...
配置hosts文件，使image.leyou.com可以访问fastDFS服务器
 ...
 ![1543400932873](1543400932873.png)

### 3.5.5.测试

创建测试类：

 ![1528207829275](1528207829275.png)
...
![1532920403019](1532920403019.png)

访问最后一个路径（缩略图路径），**注意加组名（group1）**：

![1532920492769](1532920492769.png)
...
![1528208647458](1528208647458.png)

![1528208592430](1528208592430.png)
...
![1528210076570](1528210076570.png)

 ![1528210349042](1528210349042.png)
...
![1532923048027](1532923048027.png)
...
![1528210800331](1528210800331.png)
...
- 第一步：在编辑时获取当前选中的品牌信息，并且记录到data中
  ...
  ![1528210594296](1528210594296.png)
...
- 第三步：在子组件（MyBrandForm.vue）中通过props接收要编辑的brand数据，Vue会自动完成回显
  ...
  ![1528211066645](1528211066645.png)
...
测试：发现数据回显了，除了商品分类以外：
 ...
 ![1528211235872](1528211235872.png)
...
再次测试：数据成功回显了
 ...
 ![1526222999115](1526222999115.png)
...
第一步：在父组件中记录状态：
 ...
 ![1526224372366](1526224372366.png)



第二步：在新增和修改前，更改状态：

 ![1526224447288](1526224447288.png)

第三步：传递给子组件

 ![1526224495244](1526224495244.png)

第四步，子组件接收标记：

 ![1526224563838](1526224563838.png)



标题的动态化：

 ![1526224628514](1526224628514.png)
